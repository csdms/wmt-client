...
public class Constants {
  ...
  public static String MODEL_OPEN = "Open a saved tool.";
  public static String MODEL_SAVE = "Save the current tool to the server.";
  public static String MODEL_RUN = "Run the current tool on a HPCC.";
  public static String MODEL_MORE = "See more options...";
  public static String MODEL_SAVE_AS = "Save a tool with a new name.";
  public static String MODEL_DUPLICATE = "Make a duplicate of this tool.";
  public static String MODEL_LABELS = "Manage the labels set on a tool.";
  public static String MODEL_DELETE = "Delete a saved tool from the server.";
  public static String MODEL_RUN_STATUS = "Get the status of tool run.";
  ...
  public static String COMPONENT_CLOSE =
      "Remove this component (and its children, if any) from the tool.";
  ...
  public static String PARAMETER_VIEW_CURRENT = "View the input files"
      + " generated by the current parameter values. The tool must be saved.";
